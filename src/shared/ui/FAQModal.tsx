  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: t({
        ...
        message:
          "Yes. All your audio and transcriptions stay on your device. We never collect or transmit your recordings.",
      }),
    },
    {
      question: t({
      ...
      answer: t({
        ...
        message:
          "Your data is your data. Not ours to share. We will never sell or share your data with third parties.",
      }),
    },
    {
      question: t({
