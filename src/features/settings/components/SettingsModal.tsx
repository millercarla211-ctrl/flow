                  ...
                  <AnimatePresence mode="wait">
                    ...
                    {form.activeTab === "general" && (
                      <GeneralTab
                        ...
                        smartShortcuts={form.smartShortcuts}
                        smartEnabled={form.smartEnabled}
                        setSmartEnabled={form.setSmartEnabled}
                        holdShortcuts={form.holdShortcuts}
                        holdEnabled={form.holdEnabled}
                        setHoldEnabled={form.setHoldEnabled}
                        toggleShortcuts={form.toggleShortcuts}
                        toggleEnabled={form.toggleEnabled}
                        setToggleEnabled={form.setToggleEnabled}
                        commandShortcuts={form.commandShortcuts}
                        commandEnabled={form.commandEnabled}
                        setCommandEnabled={form.setCommandEnabled}
                        pasteLastTranscriptShortcuts={form.pasteLastTranscriptShortcuts}
                        pasteLastTranscriptEnabled={form.pasteLastTranscriptEnabled}
                        setPasteLastTranscriptEnabled={form.setPasteLastTranscriptEnabled}
                        cancelShortcuts={form.cancelShortcuts}
                        cancelEnabled={form.cancelEnabled}
                        setCancelEnabled={form.setCancelEnabled}
                        wakeListeningEnabled={form.wakeListeningEnabled}
                        setWakeListeningEnabled={form.setWakeListeningEnabled}
                        wakePhrases={form.wakePhrases}
                        setWakePhrases={form.setWakePhrases}
                        wakeSpeakerVerificationEnabled={form.wakeSpeakerVerificationEnabled}
                        setWakeSpeakerVerificationEnabled={form.setWakeSpeakerVerificationEnabled}
                        wakeSpeakerProfile={form.wakeSpeakerProfile}
                        setWakeSpeakerProfile={form.setWakeSpeakerProfile}
                        captureActive={form.captureActive}
                        capturePreview={form.capturePreview}
                        onStartCapture={form.handleStartCapture}
                        removeShortcut={form.removeShortcut}
                        addShortcutSlot={form.addShortcutSlot}
                        addMouseShortcut={form.addMouseShortcut}
                        error={form.error}
                    ...
                    {form.activeTab === "models" && (
                      <ModelsTab
                        ...
                        modelStatus={form.modelStatus}
                        ttsModelCatalog={form.ttsModelCatalog}
                        ttsModelStatus={form.ttsModelStatus}
                        downloadState={form.downloadState}
                        localModel={form.localModel}
                        setLocalModel={form.setLocalModel}
                        ttsEnabled={form.ttsEnabled}
                        setTtsEnabled={form.setTtsEnabled}
                        ttsAutoAfterStt={form.ttsAutoAfterStt}
                        setTtsAutoAfterStt={form.setTtsAutoAfterStt}
                        ttsAutoPlay={form.ttsAutoPlay}
                        setTtsAutoPlay={form.setTtsAutoPlay}
                        ttsVolume={form.ttsVolume}
                        setTtsVolume={form.setTtsVolume}
                        ttsModel={form.ttsModel}
                        setTtsModel={form.setTtsModel}
                        ttsVoiceMode={form.ttsVoiceMode}
                        setTtsVoiceMode={form.setTtsVoiceMode}
                        ttsSpeaker={form.ttsSpeaker}
                        setTtsSpeaker={form.setTtsSpeaker}
                        ttsInstruction={form.ttsInstruction}
                        setTtsInstruction={form.setTtsInstruction}
                        handleDownload={form.handleDownload}
                        handleDelete={form.handleDelete}
                        handleTtsDownload={form.handleTtsDownload}
                        handleTtsDelete={form.handleTtsDelete}
