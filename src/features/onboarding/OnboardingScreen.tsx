    ...
    try {
      ...
      await invoke("update_settings", {
        args: {
          ...
          cancelShortcut: "Control+Alt+Escape",
          cancelEnabled: false,
          ...
          vibeCodingEnabled: true,
          vibeCodingVariableRecognition: true,
          vibeCodingFileTagging: true,
          vibeCodingIncludeWindowContext: true,
